...
fileObject = open(training_directory+"feature_dict.pickle",'rb')
...
fileObject = open(training_directory+"molecule_dict.pickle",'rb')
...
fileObject = open(training_directory+"molecule_dict_filter.pickle",'wb') # open the file for writing
